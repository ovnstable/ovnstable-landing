                ...
                <v-row class="d-flex justify-space-around card-container-row" :class="isMobile ? 'flex-column mt-0' : 'flex-row'">
                    <v-col :cols="isMobile ? 12 : (isTablet ? 6 : 4)">
                        <v-container class="card-container">
                            ...
                            <v-row :class="isMobile ? 'mb-5' : 'mb-12'" class="desc-row" justify="start">
                    ...
                    <v-col :cols="isMobile ? 12 : (isTablet ? 6 : 4)">
                        <v-container class="card-container">
                            <v-row :class="isMobile ? 'ma-5' : 'mt-12 mb-8 ml-5'" class="title-row" justify="left">
                    ...
                    <v-col :cols="isMobile ? 12 : (isTablet ? 6 : 4)">
                        <v-container class="card-container">
                            ...
                            <v-row :class="isMobile ? 'mb-5' : 'mb-12'" class="desc-row" justify="start">
                                ...
                                <label :class="isMobile ? 'mx-8 mt-4' : 'mx-8 mt-6'" class="link" @click="openModal(showHall)">How it works</label>
                            </v-row>
                        </v-container>
                    </v-col>
                    ...
                    <v-col :cols="isMobile ? 12 : (isTablet ? 6 : 6)">
                        <v-container class="card-container second-row">
                            <v-row :class="isMobile ? 'ma-5' : 'mt-12 mb-8 ml-5'" class="title-row" justify="space-between">
                                ...
                                <label :class="isMobile ? 'ml-auto' : 'mr-10 mb-5'" class="in-development" >In development</label>
                            </v-row>
                    ...
                    <v-col :cols="isMobile ? 12 : (isTablet ? 6 : 6)">
                        <v-container class="card-container second-row last-desc mb-10">
                            ...
                            <v-row :class="isMobile ? 'mb-5' : 'mb-16'" class="desc-row" justify="start">
